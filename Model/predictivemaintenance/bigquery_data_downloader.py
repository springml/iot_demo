...
train_file.to_csv(arguments['gbucket'] + 'data/turbofan_data_train.csv', index=False,  header=False)
eval_file.to_csv(arguments['gbucket'] + 'data/turbofan_data_val.csv', index=False, header=False)

# python bigquery_data_downloader.py --project=mlpdm-168115 --table=FleetMaintainance.DeviceSensorReadings --gbucket='gs://mlpdm/pdmdemo/'
